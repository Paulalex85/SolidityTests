...
describe('[Challenge] The rewarder', function () {
    ...
    it('Execution', async function () {
        ...
        const rewarderAttacker = await RewarderAttackerFactory.deploy(player.address, rewarderPool.address, flashLoanPool.address);
        await rewarderAttacker.connect(player).attack();
    });
